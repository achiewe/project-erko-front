...
export default function MainTeamContainer() {
  return (
    <div
      className="flex mt-[1px] items-center justify-center w-full h-full gap-x-[30px] 
    bg-[#FFFFF0] border-r-2 border-b-2 border-gray-800 drop-shadow-[4px_3px_3px_rgba(0,0,0,0.40)] py-[20px] relative lg:h-[605px]"
    >
      <div className="w-[318px] flex flex-row flex-wrap items-center justify-end md:w-full md:justify-center gap-y-[40px] gap-x-[20px] lg:gap-[80px] lg:px-[23px] 2xl:px-[41px] lg:justify-start">
