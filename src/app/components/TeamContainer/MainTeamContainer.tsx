...
export default function MainTeamContainer() {
  ...
  gap-y-[0px] flex-wrap gap-x-[30px] bg-[#FFFFF0] border-r-2 border-b-2 border-gray-800 drop-shadow-[4px_3px_3px_rgba(0,0,0,0.40)] h-mm:pt-[0px] py-[20px] relative"
    >
      <TeamCardErko title="Luka" imageSrc={LukaPxl} link="/erko/socials" />
      <TeamCardErko title="Temiko" imageSrc={TemikoPxl} link="/erko/socials" />
      <TeamCardErko title="achi" imageSrc={AchiPxl} link="/erko/socials" />
      <TeamCardErko title="Luka" imageSrc={LukaPxl} link="/erko/socials" />
      <TeamCardErko title="Luka" imageSrc={LukaPxl} link="/erko/socials" />
      <TeamCardErko title="Luka" imageSrc={LukaPxl} link="/erko/socials" />
    </div>
