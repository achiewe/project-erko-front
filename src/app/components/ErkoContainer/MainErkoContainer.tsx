...
export default function MainErkoContainer() {
  return (
    <div
      className="flex mt-[1px] flex-row items-center justify-center w-full h-full h-sm:h-[570px] h-mm:h-[510px]  
      h-mn:h-[450px] h-mn:gap-y-[0px] h-mm:pt-[0px] gap-y-[10px] flex-wrap gap-x-[50px] bg-[#FFFFF0] 
