...
export default function MainErkoContainer() {
  return (
    <div
      className="flex mt-[1px] flex-row items-center justify-center w-full h-full h-sm:gap-[15px] h-sm:h-[570px] h-mm:h-[500px] gap-y-[10px] flex-wrap gap-x-[50px] bg-[#FFFFF0] 
