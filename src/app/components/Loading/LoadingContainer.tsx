...
export default function LoadingContainer() {
  return (
    <div
      className="flex flex-col overflow-hidden w-full h-full h-sm:gap-[15px] h-sm:h-[650px] h-mm:h-[550px] h-mn:h-[500px] justify-start items-center gap-[40px] bg-[#FFFFF0] 
