...
export default function LoadingContainer() {
  return (
    <div className="flex flex-col w-full h-full justify-start items-center gap-[40px] bg-[#FFFFF0] border-r-2 border-b-2 border-gray-800 drop-shadow-[4px_3px_3px_rgba(0,0,0,0.40)] pt-[30px]">
