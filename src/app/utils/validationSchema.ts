...
export const userSchema = yup.object({
  ...
  telegram: yup.string().matches(/^https:\/\/t\.me\/[A-Za-z0-9_]+$/, "Invalid Telegram URL").notRequired().nullable(),
  instagram: yup.string().matches(/^https:\/\/(www\.)?instagram\.com\/[A-Za-z0-9_\.]+$/, "Invalid Instagram URL").notRequired().nullable(),
